...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class NoAPITokenError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "NoAPITokenError";
        ...
        /// <example>
        /// <code>
        /// "name": "The Broker did not supply an API key."
        /// </code>
        /// </example>
        [DataMember(Name = "name", EmitDefaultValue = false, Order = 7)]
        [JsonConverter(typeof(ValuesConverter))]
        public override string Name { get; set; } = "The Broker did not supply an API key.";
