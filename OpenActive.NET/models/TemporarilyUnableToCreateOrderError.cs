...
namespace OpenActive.NET
{
    ...
    /// 
    /// ## **Error Use Case**
    /// The Booking System is unable for technical reasons to create an `Order` where the data provided to it is sufficient to allow it to do so.
    /// 
    ...
    /// </summary>
    [DataContract]
    public partial class TemporarilyUnableToCreateOrderError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "TemporarilyUnableToCreateOrderError";
        ...
        public override string Name { get; set; } = "The Booking System is unable for technical reasons to create an 'Order' where the data provided to it is sufficient to allow it to do so.";
