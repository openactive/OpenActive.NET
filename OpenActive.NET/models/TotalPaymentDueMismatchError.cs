...
namespace OpenActive.NET
{
    ...
    public partial class TotalPaymentDueMismatchError : OpenBookingError
    {
        ...
        public override string Type => "TotalPaymentDueMismatchError";
        ...
        public override string Name { get; set; } = "The 'totalPaymentDue' property of the submitted 'Order' or 'OrderProposal' does not match the value calculated for that 'Order' or 'OrderProposal' by the Booking System.";
