...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class IncompleteIntakeFormError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "IncompleteIntakeFormError";
        ...
        public override string Name { get; set; } = "The 'orderItemIntakeFormResponse' is missing fields that are specified as 'valueRequired' within the 'orderItemIntakeForm'.";
