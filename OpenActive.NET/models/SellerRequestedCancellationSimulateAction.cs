...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class SellerRequestedCancellationSimulateAction : OpenBookingSimulateAction
    {
        /// <summary>
        ...
        public override string Type => "test:SellerRequestedCancellationSimulateAction";
