...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvalidIntakeFormError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "InvalidIntakeFormError";
        ...
        public override string Name { get; set; } = "The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.";
