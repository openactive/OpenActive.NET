...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderItemIdInvalidError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "OrderItemIdInvalidError";
        ...
        public override string Name { get; set; } = "The '@id' of at least one of the provided 'OrderItem's is invalid.";
