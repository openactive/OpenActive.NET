...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpportunityIsFullError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "OpportunityIsFullError";
        ...
        public override string Name { get; set; } = "There are no available spaces for the Opportunity contained in the 'orderedItem' property.";
