...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class DataCatalogCollection : Schema.NET.CreativeWork
    {
        /// <summary>
        ...
        public override string Type => "DataCatalogCollection";

        
        /// <summary>
        /// The name of the DataCatalogCollection
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// <summary>
        /// The date this `DataCatalogCollection` was last updated.
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// <summary>
        /// The date this `DataCatalogCollection` was first published. Can be specified as a `schema:Date` or `schema:DateTime`.
        /// </summary>
        /// <example>
        /// <code>
        ...
        /// </code>
        /// </example>
        [DataMember(Name = "datePublished", EmitDefaultValue = false, Order = 9)]
        [JsonConverter(typeof(ValuesConverter))]
        public new virtual SingleValues<string, DateTimeOffset?> DatePublished { get; set; }


        /// <summary>
        /// The URLs of each `DataCatalog` within this `DataCatalogCollection`.
        /// </summary>
        /// <example>
        /// <code>
        /// "hasPart": [
        ...
        /// </code>
        /// </example>
        [DataMember(Name = "hasPart", EmitDefaultValue = false, Order = 10)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// <summary>
        /// The organization ultimately responsible for maintaining this `DataCatalogCollection`.
        /// </summary>
        /// <example>
        /// <code>
        /// "publisher": {
