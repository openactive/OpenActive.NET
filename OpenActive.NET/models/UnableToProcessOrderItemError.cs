...
namespace OpenActive.NET
{
    ...
    public partial class UnableToProcessOrderItemError : OpenBookingError
    {
        ...
        public override string Type => "UnableToProcessOrderItemError";
        ...
        public override string Name { get; set; } = "'OrderItem' errors would have been generated at C2 given the same set of 'OrderItem's. The Broker is expected to retry C2 to retrieve such errors.";
