...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class IncompletePaymentDetailsError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "IncompletePaymentDetailsError";
        ...
        public override string Name { get; set; } = "The 'payment' property of the 'Order' does not include 'identifier'.";
