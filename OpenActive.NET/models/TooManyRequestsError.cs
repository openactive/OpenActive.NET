...
namespace OpenActive.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class TooManyRequestsError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "TooManyRequestsError";
        ...
        /// <example>
        /// <code>
        /// "name": "The Booking System is rate-limiting the Broker."
        /// </code>
        /// </example>
        [DataMember(Name = "name", EmitDefaultValue = false, Order = 7)]
        [JsonConverter(typeof(ValuesConverter))]
        public override string Name { get; set; } = "The Booking System is rate-limiting the Broker.";
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override long? StatusCode { get; set; } = 429;
