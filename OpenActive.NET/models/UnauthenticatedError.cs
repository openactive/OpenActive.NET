...
namespace OpenActive.NET
{
    ...
    /// 
    /// ## **Error Use Case**
    /// The Broker did not supply any form of authentication.
    /// 
    ...
    /// </summary>
    [DataContract]
    public partial class UnauthenticatedError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "UnauthenticatedError";
        ...
        public override string Name { get; set; } = "The Broker did not supply any form of authentication.";
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override long? StatusCode { get; set; } = 403;
