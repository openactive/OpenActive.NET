...
namespace OpenActive.NET
{
    ...
    /// 
    /// ## **Error Use Case**
    /// The Broker supplied an invalid set of authorization details, either malformed or expired.
    /// 
    ...
    /// </summary>
    [DataContract]
    public partial class InvalidAuthorizationDetailsError : OpenBookingError
    {
        /// <summary>
        ...
        public override string Type => "InvalidAuthorizationDetailsError";
        ...
        public override string Name { get; set; } = "The Broker supplied an invalid set of authorization details, either malformed or expired.";
