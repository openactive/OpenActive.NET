...
namespace OpenActive.NET.Test
{
    ...
    public class RPDETest
    {
        ...
        public void DeserializeRpdePageEveryoneActive()
        {
            ...
            Assert.Equal(this.jsonRpdeEveryoneActive.Replace("http://", "https://").Replace("\"type\"", "\"@type\"").Replace("\"id\":", "\"@id\":").Replace("\"id\" :", "\"id\":").Replace("[\"https://openactive.io/\"]", "\"https://openactive.io/\""), json);
        }
